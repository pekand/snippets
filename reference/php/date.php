...
echo date('u').PHP_EOL; // (microseconds) (not supported always 00000 - supported only by DateTime)
echo date('v').PHP_EOL; // (milliseconds) (not supported always 000 - supported only by DateTime)
