...
document.getElementById("id").addEventListener("focusin", function(){ });
...
document.getElementById("id").addEventListener("mousewheel", function(){ });
...
document.getElementById("id").addEventListener("search", function(){ });
